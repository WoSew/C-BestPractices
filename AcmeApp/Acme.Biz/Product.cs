...
namespace Acme.Biz
{
    ...
    public class Product
    {
        ...
        public Product(int productId, string productName, string description) : this()
        {
            ...
            if (ProductName.StartsWith("Game"))
            {
        ...
        public string ProductName
        {
            ...
            set
            {
                if (value.Length < 3)
                {
                    ValidationMassage = "Product Name must be at least 3 characters.";
                }
                else if (value.Length > 20)
                {
                    ValidationMassage = "Product Name cannot be more than 20 characters.";
                }
                else
                {
                    productName = value;
        ...
        public string ValidationMassage { get; private set; }
